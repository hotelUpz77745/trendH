...
PROVEN_LEADERS = {
    ...
    "u3_anti_aggr": {
        "rank": "🥉",
        "badge": " 💎 [PROVEN LEADER]",
        "stats": "251 сд. | WR: 56.2% | Realized: +18.29$ | Net: -7.82$"
    }
}


def is_proven_leader(uid: str) -> bool:
    """Проверяет, входит ли стратегия в топ-3 доказанных лидеров реальных торгов."""
...
STRATEGY_DESCRIPTIONS: Dict[str, Dict[str, str]] = {
    ...
    "u3_anti_aggr": {
        "name": "Aggressive Volume Fade 🥉",
        "concept": "<b>Агрессивный скальпинг локальных перерастяжек.</b> Вход на резком объеме против микро-пробоя без оглядки на старший таймфрейм. Быстрый сбор локальных возвратов.",
        "entry": "• <b>S/R Anti (5m)</b>: Ложный импульс за локальный уровень.\n• <b>Volume Filter (1m)</b>: Резкий импульсный объем на минутном баре.",
        "exit": "• <b>Take Profit</b>: +1.8%\n• <b>Stop Loss</b>: -3.0%\n• <b>Trend Reversal Anti</b>: Выход при закреплении пробоя.",
        "note": "🥉 <b>Лидер #3 по валовой прибыли</b>: +18.29$ Gross, 251 сделка (требует оптимизации комиссий)."
    },
    "u_hvh_pullback": {
